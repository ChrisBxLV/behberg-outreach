...
import { ProspectCrawlerControlCenter } from "@/components/prospect/ProspectCrawlerControlCenter";
...
function ProspectDbPanel() {
  ...
  return (
    <div className="space-y-4">
      <ProspectCrawlerControlCenter settingsCard={<ProspectCrawlerSettingsCard />} />

      <Card className="border-border/50">
        <CardHeader>
          <CardTitle className="text-base">Initialization</CardTitle>
          <CardDescription>
            Seeds crawl sources (and optional bootstrap CSV). Bounded ticks can run from the Control Center or here when
            you choose &quot;Run ticks&quot;.
          </CardDescription>
        </CardHeader>
